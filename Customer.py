...
class CustomerData:
    ...
    def save(self, customers):
        with open(self.filename, 'w', newline='') as file:
            ...
            writer.writerow(['name', 'phone', 'email', 'id'])
            for customer in customers:
                writer.writerow([customer.name, customer.phone, customer.email, customer.id])
    ...
    def load(self):
        ...
        with open(self.filename, 'r', newline='') as file:
            ...
            for row in reader:
                customers.append(Customer(row['name'], row['phone'], row['email'], row['id']))
        return customers
